...
public class CourrierSent {
    ...
    public CourrierSent(Courrier courrier) {
        ...
        this.boiteAuLettre = Func.siteAdresse + Func.routeSecureBoiteAuLettreController + String.format(Func.routeSecureBoiteAuLettreControllerGetMailBoxById,courrier.getBoiteAuLettre().getId());
    }
}
