...
public class BoiteAuLettreSent {
    ...
    public BoiteAuLettreSent(BoiteAuLettre boiteAuLettre) {
        ...
        this.courriers = Func.siteAdresse + Func.routeSecureCourrierController + String.format(Func.routeSecureCourrierControllerGetMailByMailBoxId,boiteAuLettre.getId());
    }
}
